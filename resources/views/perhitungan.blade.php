...
@section('content')
    ...
    {{-- ---------KONVERSI NILAI DATA------------- --}}
     <div class="container mt-5">
        <h2>1. Konversi Nilai Data Alternatif</h2>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#konversiModal">
            Keterangan Konversi
        </button>
        <hr>
        <table class="table table-bordered">
    ...
    {{-- ---------KONVERSI NILAI DATA------------- --}}
     <div class="container mt-5">
    <h2>5. Hasil Perhitungan & Perankingan</h2>
        ...
        <tbody>
            @foreach ($data as $index => $item)
                <tr>
                    ...
                    <td>{{ $item->c5 }}</td>
                    <td>{{ $item->v }}</td>
                    <td>{{ $index + 1 }}</td> <!-- Ranking berdasarkan urutan -->
                </tr>
            @endforeach
        </tbody>
    </table>
